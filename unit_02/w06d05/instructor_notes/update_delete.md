...
I'd like you to document what each piece is doing.

You're going to open issues on the repo formatting the title with the line you're starting from and ending at, and a small description of what you're describing.
...
You also might open issues on lines of code that you don't understand, and your fellow students or myself will respond.
...
This repo can then be used as a resource! *(NOT AS A PLACE TO COPY + PASTE FROM)*
